...
# Create bar chart
fig = px.bar(data, group_col, "Sales",color_discrete_sequence =['red'],hover_data={'sum':':$,.2f'})
...
# Create bar chart
fig1 = px.bar(data1,"Sales",group_col1,color_discrete_sequence =['green'],hover_data={'sum':':$,.2f'})
config = {'displayModeBar': False}
